...
/*
 * Java file that aids article search**/
public class QueryForArticle {
	
	static Logger logger = LogManager.getLogger(QueryForArticle.class);
	...
	/*
	 * Returns a set of headlines associated with keywords in the inout array*/
	...
	public static void main(final String[] args) {
		final QueryForArticle qw = new QueryForArticle();
